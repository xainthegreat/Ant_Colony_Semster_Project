...
public class AntSimGUI extends JFrame
{
	...
	private class ControlPanel extends JPanel
	{
		...
		{
			// setup button
			normalSetupButton = new JButton("Reset");
			normalSetupButton.addActionListener(buttonHandler);
			normalSetupButton.setToolTipText("Reset simulation to default starting values");
			
			// queen test button
			queenTestButton = new JButton("Fast");
			queenTestButton.addActionListener(buttonHandler);
			queenTestButton.setToolTipText("Set simulation speed to 1 turn per millisecond");
			
			// scout test button
			scoutTestButton = new JButton("Normal");
			scoutTestButton.addActionListener(buttonHandler);
			scoutTestButton.setToolTipText("Set simulation speed to 1 turn per 10 milliseconds");
			
			// forager test button
			foragerTestButton = new JButton("Slow");
			foragerTestButton.addActionListener(buttonHandler);
			foragerTestButton.setToolTipText("Set simulation speed to 1 turn per second");
			
			// soldier test button
			soldierTestButton = new JButton("Pause");
			soldierTestButton.addActionListener(buttonHandler);
			soldierTestButton.setToolTipText("Pause the simulation");
